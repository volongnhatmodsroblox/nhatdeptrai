spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To AnBaToCom Hub V2 <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join Nhat mods Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window =
    ...
    {
        Title = "AnBaToCom Hub",
        SubTitle = "Skid And Setup By Long Nhat",
        TabWidth = 160,
...
do
    Tabs.Discord:AddButton(
        {
            Title = "Copy Link Discord Long Nhat",
            Description = ".gg/yZDRPEVXtz",
            Callback = function()
    ...
    Tabs.Discord:AddButton(
        {
            Title = "Copy Link Youtube Long Nhat",
            Description = "Nhật Roblox Mods ",
            Callback = function()
                setclipboard("Nhật Roblox Mods ")
                Fluent:Notify(
                    {
                        Title = "AnBaToCom Hub V2",
                        Content = "Copied!",
                        SubContent = "", -- Optional
                        Duration = 5 -- Set to nil to make the notification not disappear
                    }
